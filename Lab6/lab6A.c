...
main(){
 ...
 in=10;
 p = &in;
 printf("%d\n\n", *p ); // pointee level to print a scalar variable
...
*arrP[2] = 5;
 ...
 for (; n<3; n++)  // print elements ; should 1 1, 3 3, 5 5
